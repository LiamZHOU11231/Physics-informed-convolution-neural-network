...
# -------------------------------------------------------------------------------------------------------------
    ...
    loc_test_out = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_result_70dB' \
                    + '\OutputTest_ShuffleFalse_NETother9.xlsx'
    loc_test_outGT = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_result_70dB' \
...
# -------------------------------------------------------------------------------------------------------------
    ...
    # 加载测试集数据
    test_dataset = DB_PFCandTcaseBase2_update1(mode='test')
