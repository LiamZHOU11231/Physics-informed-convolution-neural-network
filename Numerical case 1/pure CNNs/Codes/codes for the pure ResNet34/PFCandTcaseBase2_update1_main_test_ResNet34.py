...
# -------------------------------------------------------------------------------------------------------------
    ...
    loc_test_out = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                    + '\OutputTest_ShuffleFalse_NETother3.xlsx'
    loc_test_outGT = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
...
# -------------------------------------------------------------------------------------------------------------
    model_weight_path = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1' \
                        '\PFCandT_caseBase2_update1_ResNet34_weight_other_70dB' \
                        + '\MyConvNet_other3.pth'
# -------------------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------------------
    ...
    # 加载测试集数据
    test_dataset = DB_PFCandTcaseBase2_update1_ResNet34(mode='test')
