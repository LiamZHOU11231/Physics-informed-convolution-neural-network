...
# -------------------------------------------------------------------------------------------------------------
#           一定记得改路径！！！
from PFCandTcaseBase2_update1_func2_ResNet34 import DB_PFCandTcaseBase2_update1_ResNet34
# -------------------------------------------------------------------------------------------------------------

# Caution 2/12  确认网络 ==========================================================================================
# -------------------------------------------------------------------------------------------------------------
from PFCandTcaseBase2_update1_func3_ResNet34 import resnet34
# -------------------------------------------------------------------------------------------------------------

# Caution 3/12  确认损失函数 =======================================================================================
# -------------------------------------------------------------------------------------------------------------
from PFCandTcaseBase2_update1_func_LossErrReal_e3 import LossErrReal_USE
...
# -------------------------------------------------------------------------------------------------------------
loc_train_2nd_out = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                    + '\OutputTrain2nd_ShuffleTure_BestEpoch.xlsx'
loc_train_2nd_outGT = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                      + '\OutputTrain2ndGT_ShuffleTure.xlsx'
# -------------------------------------------------------------------------------------------------------------

# Caution 5/12  指定最后 训练集 损失、迭代评价指标的保存路径 ===========================================================
# -------------------------------------------------------------------------------------------------------------
loc_train_loss1_MAE     = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                              + '\OutputTrain_loss1_MAE.xlsx'
loc_train_2nd_Crtn1_MAE = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                              + '\OutputTrain2nd_Crtn1_MAE.xlsx'
loc_train_2nd_Crtn1_ErrReal = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                              + '\OutputTrain2nd_Crtn1_ErrReal.xlsx'
# -------------------------------------------------------------------------------------------------------------

# Caution 6/12  指定最后 验证集 输出不平衡量结果的保存路径 ============================================================
# -------------------------------------------------------------------------------------------------------------
loc_val_out = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
               + '\OutputVal_ShuffleTure_BestEpoch.xlsx'
# 由于 shuffle 的原因，真值也需要保存。
loc_val_outGT = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
               + '\OutputValGT_ShuffleTure.xlsx'
# -------------------------------------------------------------------------------------------------------------

# Caution 7/12  指定最后 验证集 迭代评价指标的保存路径 ==============================================================
# -------------------------------------------------------------------------------------------------------------
loc_val_Crtn1_MAE = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                    + '\OutputVal_Crtn1_MAE.xlsx'
loc_val_Crtn1_ErrReal = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                        + '\OutputVal_Crtn1_ErrReal.xlsx'
# -------------------------------------------------------------------------------------------------------------

# Caution 8/12  指定最后 网络权重 的保存路径 ========================================================================
# -------------------------------------------------------------------------------------------------------------
save_path = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1\PFCandT_caseBase2_update1_ResNet34_weight_70dB' \
            + '\MyConvNet.pth'
# -------------------------------------------------------------------------------------------------------------

# Caution 9/12  指定最后 结果图 的保存路径 ==========================================================================
# -------------------------------------------------------------------------------------------------------------
writer_path = "PFCandT_caseBase2_update1_ResNet34_result_70dB"
# -------------------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------------------
WeightOtherPathPrefix = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1' \
                        + '\PFCandT_caseBase2_update1_ResNet34_weight_other_70dB\\'

# -------------------------------------------------------------------------------------------------------------

# Caution 12/12  指定 smaller 结果的保存路径 =======================================================================
# -------------------------------------------------------------------------------------------------------------
loc_train_2nd_SmallerCrtn1  = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1' \
                              + '\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
                              + '\OutputTrain2nd_SmallerCrtn1_Two.xlsx'
loc_val_SmallerCrtn1    = 'D:\RFEMNN_InPyCharm\project1\ForPFCandT_NEW\PFCandT_caseBase2_update1' \
                          + '\PFCandT_caseBase2_update1_ResNet34_result_70dB' \
...
if __name__ == '__main__':
    ...
    # 加载训练集
    train_dataset = DB_PFCandTcaseBase2_update1_ResNet34(mode='train')
    train_data_loader = torchData.DataLoader(dataset=train_dataset,
                                             batch_size=batchS_train,
                                             shuffle=True)

    # 加载验证集
    val_dataset = DB_PFCandTcaseBase2_update1_ResNet34(mode='val')
    ...
    for epoch in range(epochs_USE):
        ...
        # 这样就可以保证在验证阶段，不改变网络权重。
            ...
            for sample_train_2nd in train_bar_2nd:
                img_train_2nd = sample_train_2nd['img']
