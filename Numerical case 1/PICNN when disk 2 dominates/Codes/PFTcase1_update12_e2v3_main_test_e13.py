...
# -------------------------------------------------------------------------------------------------------------
    ...
    loc_test_out = 'D:\RFEMNN_InPyCharm\project1\ForPFT_NEW\PFT_case1_update12_e2v3\PFT_case1_update12_e2v3_NetV2_result_70dB' \
                    + '\OutputTest_ShuffleFalse_NETother7.xlsx'
    loc_test_outGT = 'D:\RFEMNN_InPyCharm\project1\ForPFT_NEW\PFT_case1_update12_e2v3\PFT_case1_update12_e2v3_NetV2_result_70dB' \
...
# -------------------------------------------------------------------------------------------------------------
    model_weight_path = 'D:\RFEMNN_InPyCharm\project1\ForPFT_NEW\PFT_case1_update12_e2v3' \
                        '\PFT_case1_update12_e2v3_NetV2_weight_other_70dB' \
                        + '\MyConvNet_other7.pth'
# -------------------------------------------------------------------------------------------------------------
...
# -------------------------------------------------------------------------------------------------------------
    ...
    # 加载测试集数据
    test_dataset = DB_PFTcase1_update12_e2v3(mode='test')
