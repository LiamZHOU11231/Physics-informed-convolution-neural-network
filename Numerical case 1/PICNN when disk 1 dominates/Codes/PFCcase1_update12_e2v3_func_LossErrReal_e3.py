...
def LossErrReal_USE(batchS, outputNN, outputGT):
    ...
    WithDim_output1_max = 330.631747436494
    WithDim_output1_min = 39.4784176043574
    WithDim_output2_max = 177.840000000000
    ...
    # STEP 1/3  进行反归一化
    outputNN_WithDim = torch.zeros(batchS, 2)
    outputGT_WithDim = torch.zeros(batchS, 2)
