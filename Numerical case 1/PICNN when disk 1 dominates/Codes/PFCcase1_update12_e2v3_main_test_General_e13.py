...
# -------------------------------------------------------------------------------------------------------------
    ...
    loc_test_out = 'D:\RFEMNN_InPyCharm\project1\ForPFC\PFC_case1_update12_e2v3\PFC_case1_update12_e2v3_NetV2_result_70dB' \
                    + '\OutputVal_ShuffleFalse_BestEpoch.xlsx'
    loc_test_outGT = 'D:\RFEMNN_InPyCharm\project1\ForPFC\PFC_case1_update12_e2v3\PFC_case1_update12_e2v3_NetV2_result_70dB' \
                    + '\OutputValGT_ShuffleFalse.xlsx'

# -------------------------------------------------------------------------------------------------------------

# Caution 4/6  导入训练好的参数 ================================================================================
# -------------------------------------------------------------------------------------------------------------
    model_weight_path = 'D:\RFEMNN_InPyCharm\project1\ForPFC\PFC_case1_update12_e2v3' \
                        '\PFC_case1_update12_e2v3_NetV2_weight_70dB' \
                        + '\MyConvNet.pth'
# -------------------------------------------------------------------------------------------------------------
...
# Caution 6/6  加载数据 ========================================================================================
# ⭐️ ------------------------------------------------------ ⭐️
    test_dataset = DB_PFCcase1_update12_e2v3(mode='val')
